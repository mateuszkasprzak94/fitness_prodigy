...
import 'package:fitness_prodigy/app/features/supplements/supplements_type/text_for_supplements.dart';
      ...
      body: Center(
        child: ListView(
          ...
          children: [
            ...
            _buildSupplements2('Whey Protein:', ''),
            _buildSupplements2('Casein Protein:', 'bcaatype2'),
            _buildSupplements2('Plant-Based Proteins:', 'bcaatype3'),
            _buildSupplements2('Egg White Protein', 'bcaatype4'),
            const Divider(height: 5, thickness: 5),
            const SizedBox(height: 15),
