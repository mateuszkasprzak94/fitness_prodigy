...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i9.WaterGlassCounterCubit>(() => _i9.WaterGlassCounterCubit(
        waterGlassCounterRepository: gh<_i8.WaterGlassCounterRepository>()));
    gh.factory<_i10.GoalsCubit>(
        () => _i10.GoalsCubit(goalsRepository: gh<_i6.GoalsRepository>()));
    gh.factory<_i11.WeatherRepository>(() => _i11.WeatherRepository(
        weatherRemoteDataSource: gh<_i5.WeatherRemoteDioDataSource>()));
    gh.factory<_i12.MotivationQuotesRepository>(() =>
        _i12.MotivationQuotesRepository(
            motivationQuotesRemoteDataSource:
                gh<_i4.MotivationQuotesRemoteDioDataSource>()));
    gh.factory<_i13.DetailsCubit>(
        () => _i13.DetailsCubit(gh<_i7.ItemsRepository>()));
    gh.factory<_i14.AddCubit>(() => _i14.AddCubit(gh<_i7.ItemsRepository>()));
    gh.factory<_i15.EventPlannerPageCubit>(
        () => _i15.EventPlannerPageCubit(gh<_i7.ItemsRepository>()));
    gh.factory<_i16.MotivationQuotesCubit>(() => _i16.MotivationQuotesCubit(
        motivationQuotesRepository: gh<_i12.MotivationQuotesRepository>()));
    gh.factory<_i17.WeatherCubit>(() =>
        _i17.WeatherCubit(weatherRepository: gh<_i11.WeatherRepository>()));
    return this;
  }
}
