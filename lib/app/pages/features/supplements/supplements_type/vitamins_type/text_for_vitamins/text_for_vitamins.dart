...
String supplementationVitaminC =
    "While it's ideal to get your Vitamin C from a balanced diet rich in fruits and vegetables, supplements can be beneficial, especially for individuals with dietary restrictions or specific health needs. Vitamin C supplements are available in various forms, including tablets, capsules, and powders.";

String intakeVitaminC =
...
String sourceVitaminD = """There are two primary sources of Vitamin D:
...
String supplementationVitaminD =
    "Vitamin D supplements are commonly used, especially in regions with limited sunlight or for individuals with specific health conditions. These supplements are available in various forms, including Vitamin D2 (ergocalciferol) and Vitamin D3 (cholecalciferol). Vitamin D3 is typically recommended for supplementation, as it's more effective at raising blood levels of the vitamin.";

String intakeVitaminD =
