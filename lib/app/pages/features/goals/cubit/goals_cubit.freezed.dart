...
/// @nodoc
mixin _$GoalsState {
  List<GoalModel> get items => throw _privateConstructorUsedError;
...
abstract class $GoalsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<GoalModel> items, bool isLoading, String? errorMessage});
}
...
class _$GoalsStateImpl implements _GoalsState {
  _$GoalsStateImpl(
      {final List<GoalModel> items = const [],
      this.isLoading = false,
      this.errorMessage})
      : _items = items;

  final List<GoalModel> _items;
  @override
  @JsonKey()
  List<GoalModel> get items {
  ...
  @override
  String toString() {
    return 'GoalsState(items: $items, isLoading: $isLoading, errorMessage: $errorMessage)';
  }
...
abstract class _GoalsState implements GoalsState {
  factory _GoalsState(
      ...
      final bool isLoading,
      final String? errorMessage}) = _$GoalsStateImpl;
